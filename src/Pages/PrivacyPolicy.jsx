  ...
  return (
    <>
      ...
      <div className="privacy-container" ref={containerRef}>
        <h1 className="highlight-text reveal">Privacy Policy</h1>
        <p className="ggg reveal">Last updated: June 17, 2025</p>
        <p className="reveal">
        ...
        <h2 className="highlight-text reveal">
        ...
        <p className="reveal">For the purposes of this Privacy Policy:</p>
        <ul className="reveal">
          <li className="reveal">
            <p className="reveal">
          ...
          <li className="reveal">
            <p className="reveal">
              ...
              in this Agreement) refers to Vcraftyu Company , thirukazhukundram,
              chengalpattu .
            </p>
          </li>
          <li className="reveal">
          ...
          <li className="reveal">
            <p className="reveal">
              <strong>Website</strong> refers to Vcraftyu Company Digital Tech
              Company Chennai, India, accessible from{" "}
              <a
                href="https://vcraftyucompany.com"
                rel="external nofollow noopener"
                target="_blank"
                className="highlight-text"
              >
                https://vcraftyucompany.com
              </a>
            </p>
          </li>
          <li className="reveal">
        ...
        <h2 className="highlight-text reveal">Types of Data Collected</h2>
        <h3 className="highlight-text reveal"> Personal Data</h3>
        <p className="reveal">
        ...
        <ul className="reveal">
          <li className="reveal">
            <p className="reveal">Email address</p>
          </li>
          <li className="reveal">
            <p className="reveal">First name and last name</p>
          </li>
          <li className="reveal">
            <p className="reveal">Phone number</p>
          </li>
          <li className="reveal">
            <p className="reveal">
          ...
          <li className="reveal">
            <p className="reveal">Usage Data</p>
          </li>
        </ul>

        <h3 className="highlight-text reveal">Usage Data</h3>
        <p className="reveal">
        ...
        <h3 className="highlight-text reveal">
        ...
        <ul className="reveal">
          ...
          <p className="reveal">Type: Session Cookies</p>
          <p className="reveal">Administered by: Us</p>
          <p className="reveal">
        ...
        <ul className="reveal">
          ...
          <p className="reveal">Type: Persistent Cookies</p>
          <p className="reveal">Administered by: Us</p>
          <p className="reveal">
        ...
        <h2 className="highlight-text reveal">Use of Your Personal Data</h2>
        <p className="reveal">
        ...
        <ul className="reveal">
          ...
          <li className="reveal">
            <p className="reveal">
              ...
              marketing and your experience. information.
            </p>
          </li>
        ...
        <h2 className="highlight-text reveal">Delete Your Personal Data</h2>
        <p className="reveal">
        ...
        <h3 className="highlight-text reveal">Business Transactions</h3>
        <p className="reveal">
        ...
        <h3 className="highlight-text reveal">Law enforcement</h3>
        <p className="reveal">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h3 className="highlight-text reveal">Other legal requirements</h3>
        <p className="reveal">
        ...
        <ul className="reveal">
          <li className="reveal">
            <p className="reveal">Comply with a legal obligation</p>
          </li>
          <li className="reveal">
            <p className="reveal">
          ...
          <li className="reveal">
            <p className="reveal">Protect against legal liability</p>
          </li>
        </ul>
        ...
        <ul className="reveal">
          <li className="reveal">
            ...
            <p className="reveal">
              ...
              <br />
              <a
                href="mailto:hi@vcraftyucompany.com"
                className="highlight-text"
              >
        ...
        <h2 className="highlight-text reveal">Children's Privacy</h2>
        <p className="reveal">
        ...
        <h2 className="highlight-text reveal">Links to Other Websites</h2>
        <p className="reveal">
        ...
        <h2 className="highlight-text reveal">Contact Us</h2>
        <p>

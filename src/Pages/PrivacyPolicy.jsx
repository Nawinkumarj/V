...
const PrivacyPolicy = () => {
  ...
  return (
    ...
    >
      ...
      <h2 className="highlight-text reveal">Interpretation and Definitions</h2>
      ...
      <p className="reveal">For the purposes of these Terms and Conditions:</p>
      <ul className="reveal">
        <li className="reveal">
          <p className="reveal">
        ...
        <li className="reveal">
          <p className="reveal">
            ...
            this Agreement) refers to Vcraftyu Company , thirukazhukundram,
            chengalpattu .
          </p>
        </li>
        <li className="reveal">
      ...
      <h2 className="highlight-text reveal">Acknowledgment</h2>
      <p className="reveal">
      ...
      <h2 className="highlight-text reveal">Termination</h2>
      <p className="reveal">
      ...
      <h2 className="highlight-text reveal">Limitation of Liability</h2>
      <p className="reveal">
      ...
      <h2 className="highlight-text reveal">Governing Law</h2>
      <p className="reveal">
      ...
      <h2 className="highlight-text reveal">Disputes Resolution</h2>
      <p className="reveal">
      ...
      <h2 className="highlight-text reveal">For European Union (EU) Users</h2>
      <p className="reveal">
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which You are
        resident.
      </p>
      <h2 className="highlight-text reveal">United States Legal Compliance</h2>
      <p className="reveal">
      ...
      <h2 className="highlight-text reveal">Severability and Waiver</h2>
      <h3 className="reveal">Severability</h3>
      <p className="reveal">
      ...
      <h2 className="highlight-text reveal">Translation Interpretation</h2>
      <p className="reveal">
      ...
      <ul>
        <li className="reveal">
          <p className="reveal">
            By email:{" "}
            <a href="mailto:hi@vcraftyucompany.com" className="highlight-text">
        ...
        <li className="reveal">
          <p className="reveal">
            By phone number:
            <a href="tel:+91 9840488033" className="highlight-text">
              {" "}
              9840488033
            </a>
          </p>

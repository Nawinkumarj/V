      ...
      <div className="aboutUs-container">
        <div className="aboutUs-content" ref={aboutRef}>
          ...
          <p className="aboutDescription">
            ...
            but a laptop and a dream, we’ve grown into a powerhouse of creators,
            ...
            bit of madness).<span className="highlight-text">Vcraftyu</span>{" "}
            isn’t just our name — it’s our mindset. Let’s make something
            unforgettable.
          </p>
        </div>
      </div>
